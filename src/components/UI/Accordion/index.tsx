...
import {AccordionContext, AccordionItemContext, useAccordionContext, useAccordionItemContext} from './context';
...
const Accordion: AccordionComponent = ({children, initialVisibleId}) => {
  ...
  return (
    <div className={cx('Accordion')}>
      <AccordionContext.Provider value={{visibleId: visible, setVisibleId: setVisible}}>
        {children}
      </AccordionContext.Provider></div>
  );
};
